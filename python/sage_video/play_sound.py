...
if __name__ =='__main__':
    ...
    for tile_id in cfg['tiles']:
        ...
        cmdline=['ssh','-t',renderer['address'],'/usr/bin/yuri2',os.path.join(renderer['dir'],CFG_FILE),'resolution=%dx%d'%(part_width,part_height),'file='+outfilename+'_%s.mp4'%tile_id]
